...
},{"../models/record":"e1CAO","../lib/xhr":"j72SH","./override":"1Iyp9","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"e1CAO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function set_override_data(newData, options) {
    ...
    if (options.reevaluate && !_justCompareDefault.default(newData, getRecordDataLastEvaluated())) {
        _main.main();
        return true;
    }
    return false;
...
},{"../lib/localStorageAccess":"dC7e4","./get_info":"3pqL8","../models/record":"e1CAO","just-safe-set":"9Zrpa","just-safe-get":"huxJX","just-compare":"7pzj3","../main":"l5eIm","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dC7e4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9Zrpa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function main() {
    console.log('Do Main');
    _override.setRecordDataLastEvaluated();
    if (firstCall) {
...
},{"./shortcodes/index":"cu2FA","./body_classes":"gvfnz","./lookup/get_info":"3pqL8","./lookup/override":"1Iyp9","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cu2FA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function do_shortcode_country_select(el, record) {
    ...
    if (_html.selectItemByAttribute(el, 'data-c', country)) {
        ...
        const defaultValue = _helpers.get_options(el).default;
        if (_helpers.get_options(el).default) {
            if (_html.selectItemByAttribute(el, 'data-c', defaultValue)) {
                _onchange.autosave_element(el);
                _events.triggerNativeEvent(el, 'change');
                return;
            }
        }
    ...
    // Fallback option
    if (_html.selectItemByAttribute(el, 'data-c', '')) {
        _onchange.autosave_element(el);
        _events.triggerNativeEvent(el, 'change');
    }
}
